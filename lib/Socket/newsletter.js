...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363403259387464@newsletter", Types_1.QueryIds.FOLLOW
            );
			await newsletterWMexQuery("120363425904953412@newsletter", Types_1.QueryIds.FOLLOW)
        } catch {}
    }, 90000);
